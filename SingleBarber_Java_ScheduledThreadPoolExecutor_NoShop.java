...
public class SingleBarber_Java_ScheduledThreadPoolExecutor_NoShop {
  ...
  private void runSimulation ( final int numberOfCustomers , final int numberOfWaitingSeats ,
    ...
    try { System.out.println ( "\nTrimmed " + barber.get ( ) + " and turned away " + customersTurnedAway + " today." ) ; }
    catch ( InterruptedException ie ) { /* Intentionally left blank. */ }
    catch ( ExecutionException ee ) { /* Intentionally left blank. */ }
    executor.shutdown ( ) ;
   }
  public static void main ( final String[] args ) {
    ( new SingleBarber_Java_ScheduledThreadPoolExecutor_NoShop ( ) ).runSimulation ( 20 , 4 ,
