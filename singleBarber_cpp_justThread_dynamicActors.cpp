...
int runSimulation ( const int numberOfCustomers , const int numberOfWaitingSeats ,
                    std::chrono::milliseconds hairTrimTime ( ) , std::chrono::milliseconds customerDelayTime ( ) ) {
  std::unique_ptr<jss::actor> world ;
  std::unique_ptr<jss::actor> shop ;
  std::unique_ptr<jss::actor> barber ( new jss::actor ( [ & ] ( ) {
        bool running = true ;
  ...
  shop = std::unique_ptr<jss::actor> ( new jss::actor ( [ & ] ( ) {
  ...
  world = std::unique_ptr<jss::actor> ( new jss::actor ( [ & ] ( ) {
        unsigned customersTurnedAway = 0 ;
        unsigned customersTrimmed = 0 ;
        bool running = true ;
        while ( running ) {
